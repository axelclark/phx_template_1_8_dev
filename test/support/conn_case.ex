defmodule PhxTemplate18DevWeb.ConnCase do
  ...
  def register_and_log_in_user(%{conn: conn} = context) do
    user = PhxTemplate18Dev.AccountsFixtures.user_fixture()
    scope = PhxTemplate18Dev.Accounts.Scope.for_user(user)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = PhxTemplate18Dev.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_inserted_at(token, inserted_at) do
    PhxTemplate18Dev.AccountsFixtures.override_token_inserted_at(token, inserted_at)
  end
end
