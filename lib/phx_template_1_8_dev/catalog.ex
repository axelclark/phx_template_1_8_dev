defmodule PhxTemplate18Dev.Catalog do
  @moduledoc """
  The Catalog context.
  """
  ...
  def subscribe_products(%Scope{} = scope) do
    ...
    Phoenix.PubSub.subscribe(PhxTemplate18Dev.PubSub, "user:#{key}:products")
  end

  defp broadcast(%Scope{} = scope, message) do
    key = scope.user.id

    Phoenix.PubSub.broadcast(PhxTemplate18Dev.PubSub, "user:#{key}:products", message)
  end
