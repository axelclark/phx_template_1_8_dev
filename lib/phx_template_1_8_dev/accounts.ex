defmodule PhxTemplate18Dev.Accounts do
  @moduledoc """
  The Accounts context.
  """

  import Ecto.Query, warn: false
  alias PhxTemplate18Dev.Repo

  alias PhxTemplate18Dev.Accounts.{User, UserToken, UserNotifier}
  ...
  See `PhxTemplate18Dev.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `PhxTemplate18Dev.Accounts.User.password_changeset/3` for a list of supported options.
