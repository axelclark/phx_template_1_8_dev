defmodule PhxTemplate18DevWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxTemplate18DevWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxTemplate18DevWeb.Gettext, "errors", msg, opts)
    end
  end
